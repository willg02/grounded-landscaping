      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8" aria-label="Global">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden">
            ...
            <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-bark-900/10">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="-m-2.5 rounded-md p-2.5 text-bark-700"
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-bark-500/10">
                  <div className="space-y-2 py-6">
                    {navigation.map((item) => (
                      <a
                        ...
                        href={item.href}
                        onClick={(e) => scrollToSection(e, item.href)}
                        className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-bark-900 hover:bg-bark-50"
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <div className="py-6 space-y-4">
                    <Link
                      href="/dashboard"
                      className="block text-center text-sm font-semibold text-bark-600 hover:text-primary-600"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      Employee Login
                    </Link>
